...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
	<?php $k=0;?>
    <?php foreach ($items as $key=>$item):	$k= $k+ 0.5 ;?>
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>" data-sr="enter top and move  200px over <?php echo $k?>s">
